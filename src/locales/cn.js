...
const cn = {
  ...
  nav: {
    ...
    hsInvalidHintForServerStopped: '服务停止，',
  ...
  workspace: {
    ...
    deployDebugVm: {
      ...
      applyVmResStart: '开始生成应用包',
      applyVmResFailed: '生成应用包失败！',
    ...
    statusTested: '测试完成',
    statusReleased: '已发布',
    createProject: '应用开发项目',
    migrationProject: '应用集成项目',
  ...
  promptMessage: {
    ...
    systemCapaNameCn: '请输入长度1-20的中文名称，开头不能为空',
    systemCapaNameEn: '请输入长度1-40的英文名称，开头不能为空',
    systemCapaDescCn: '请输入长度1-200的中文描述，开头不能为空',
    systemCapaDescEn: '请输入长度1-400的英文描述，开头不能为空',
    ...
    imageInfoErr: '镜像不存在，请前往“系统-系统镜像管理”上传镜像',
