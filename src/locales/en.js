...
const en = {
  ...
  home: {
    ...
    travelStart: 'Start your application integration journey'
  },
  devTools: {
  ...
  promptMessage: {
    ...
    nameRule: 'Please enter an application name of 4-32 characters, which can contain numbers, letters, _,-and spaces, and cannot start and end with _,-and spaces',
