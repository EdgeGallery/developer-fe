    ...
    <div class="cardShadow">
      <el-card class="deploylist-card">
        ...
        >
          <el-table-column
            prop="name"
            :label="$t('deployList.name')"
          />
          <el-table-column
            prop="version"
            :label="$t('deployList.version')"
          />
          <el-table-column
            prop="provider"
            :label="$t('deployList.provider')"
          />
          <el-table-column
            prop="type"
