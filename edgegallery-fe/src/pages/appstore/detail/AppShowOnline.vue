...
import pkgUploading from '@/assets/images/appstore/pkg_uploading.png'
import pkgUploadingNone from '@/assets/images/appstore/pkg_uploadingNone.png'
import pkgGetStatusNone from '@/assets/images/appstore/pkg_getStatusNone.png'
import pkgInstatiateNone from '@/assets/images/appstore/pkg_instatiateNone.png'
import pkgGetStatusFinish from '@/assets/images/appstore/pkg_getStatusFinish.png'
import pkgReadyDeploy from '@/assets/images/appstore/pkg_readyDeploy.png'
import pkgInstatiateFinish from '@/assets/images/appstore/pkg_instatiateFinish.png'
import pkgDeployFinish from '@/assets/images/appstore/pkg_deployFinish.png'
import pkgWorking from '@/assets/images/appstore/pkg_working.png'
import tryBigTip from '@/assets/images/appstore/tryBigTip.png'
import pkgGetStatusTip from '@/assets/images/appstore/pkg_getStatusTip.png'
import pkgInstatiateTip from '@/assets/images/appstore/pkg_instatiateTip.png'
import pkgUploadingTip from '@/assets/images/appstore/pkg_uploadingTip.png'
import pkgGetStatusEndTip from '@/assets/images/appstore/pkg_getStatusEndTip.png'
import pkgInstatiateEndTip from '@/assets/images/appstore/pkg_instatiateEndTip.png'
import pkgUploadingEndTip from '@/assets/images/appstore/pkg_uploadingEndTip.png'
import pkgGetStatusTipEn from '@/assets/images/appstore/pkg_getStatusTipEn.png'
import pkgInstatiateTipEn from '@/assets/images/appstore/pkg_instatiateTipEn.png'
import pkgUploadingTipEn from '@/assets/images/appstore/pkg_uploadingTipEn.png'
import pkgGetStatusEndTipEn from '@/assets/images/appstore/pkg_getStatusEndTipEn.png'
import pkgInstatiateEndTipEn from '@/assets/images/appstore/pkg_instatiateEndTipEn.png'
import pkgUploadingEndTipEn from '@/assets/images/appstore/pkg_uploadingEndTipEn.png'
import experienceSmallTip from '@/assets/images/appstore/experienceSmallTip.png'
export default {
  props: {
    packageId: {
      required: true,
  ...
  methods: {
    ...
    loadWords (progress) {
      ...
      let _appOnline = _isCn ? appOnlineCn.appOnline : appOnlineEn.appOnline
      if (progress === 0) {
        this.fillText = _appOnline.startExperience
      } else if (progress > 0 && progress < 10) {
        this.fillText = _appOnline.waitUploadApp
      } else if (progress > 10 && progress < 45) {
        this.fillText = _appOnline.waitDistributeApp
      } else if (progress >= 45 && progress <= 50) {
        this.fillText = _appOnline.waitInstantiatedApp
      } else if (progress > 50 && progress < 90) {
        this.fillText = _appOnline.waitGetInstantiatedInfo
      } else {
        this.fillText = _appOnline.deployFinished
      }
    },
    ...
    loadingUploadByProgress (_isCn, circleX, circleY, ctx) {
      if (_isCn) {
        ...
        this.loadImage(circleX / 3 - 28, circleY + 65, ctx, this.pkgUploadingTipEn)
    ...
    loadingInstatiateByProgress (_isCn, circleX, circleY, ctx) {
      if (_isCn) {
        ...
        this.loadImage(circleX / 3 - 28, circleY + 65, ctx, this.pkgUploadingEndTipEn)
        this.loadImage(circleX + 18, circleY / 6 + 18, ctx, this.pkgInstatiateTipEn)
        this.loadImage(circleX + 200, circleY + 60, ctx, this.pkgGetStatusTipEn)
      }
    ...
    loadingGetStatusByProgress (_isCn, circleX, circleY, ctx) {
      if (_isCn) {
        this.loadImage(circleX / 3 - 10, circleY + 65, ctx, this.pkgUploadingEndTip)
        this.loadImage(circleX + 18, circleY / 6 + 18, ctx, this.pkgInstatiateEndTip)
        this.loadImage(circleX + 200, circleY + 60, ctx, this.pkgGetStatusTip)
      } else {
        this.loadImage(circleX / 3 - 28, circleY + 65, ctx, this.pkgUploadingEndTipEn)
        this.loadImage(circleX + 18, circleY / 6 + 18, ctx, this.pkgInstatiateEndTipEn)
        this.loadImage(circleX + 200, circleY + 60, ctx, this.pkgGetStatusTipEn)
      }
      this.loadImage(circleX - 190, circleY + 50, ctx, this.showEnd)
    ...
    loadCommonTip (_isCn, circleX, circleY, ctx) {
      if (_isCn) {
        this.loadImage(circleX / 3 - 10, circleY + 65, ctx, this.pkgUploadingEndTip)
        this.loadImage(circleX + 18, circleY / 6 + 18, ctx, this.pkgInstatiateEndTip)
        this.loadImage(circleX + 200, circleY + 60, ctx, this.pkgGetStatusEndTip)
      } else {
        this.loadImage(circleX / 3 - 28, circleY + 65, ctx, this.pkgUploadingEndTipEn)
        this.loadImage(circleX + 18, circleY / 6 + 18, ctx, this.pkgInstatiateEndTipEn)
        this.loadImage(circleX + 200, circleY + 60, ctx, this.pkgGetStatusEndTipEn)
      }
    },
    ...
    deployPackage () {
      ...
      appstoreApi.getNodePort(this.appId, this.packageId, this.userId).then(
        (res) => {
    ...
    getExperienceStatus () {
      appstoreApi.getExperienceStatus(this.packageId).then(
        (res) => {
    ...
    initStatus () {
      appstoreApi.getNodeStatus(this.packageId, this.userId).then(
        (res) => {
          let experienceInfo = res.data
          let tmpExperienceData = experienceInfo.data
          this.filterExperienceInfo(tmpExperienceData)
