...
const imagesEn = {
  appPackage: {
    ...
    capabilityDepend: 'Capability Depend',
    capabilityRelease: 'Capability Release',
    appdPreview: 'Build&Preview',
    build: 'Build',
    packFinished: 'Pack Finished',
    packFinishedTip: 'Before certification test, the system will release the virtual machine resources by default. After taht you can not return back to modify.',
    packBack: 'back',
