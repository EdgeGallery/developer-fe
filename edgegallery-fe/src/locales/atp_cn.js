...
const atpCn = {
  ...
  atpPromptMessage: {
    ...
    deleteSuitePrompt: '是否要继续删除此测试套？',
    deleteSenarioPrompt: '是否要继续删除此测试场景？',
  ...
  testCase: {
    ...
    provideNameCn: '请提供中文名',
    provideDescriptionCn: '请提供中文描述',
    provideTestScenario: '选择测试场景',
